...
function initStep1() {
    ...
    emailForm === null || emailForm === void 0 ? void 0 : emailForm.addEventListener('submit', async (e) => {
        e.preventDefault();
...
function initStep2() {
    ...
    // 인증번호 확인
    verifyForm === null || verifyForm === void 0 ? void 0 : verifyForm.addEventListener('submit', async (e) => {
        e.preventDefault();
...
function initStep3() {
    ...
    // 비밀번호 강도 체크
    newPasswordInput === null || newPasswordInput === void 0 ? void 0 : newPasswordInput.addEventListener('input', () => {
        const password = newPasswordInput.value;
        checkPasswordStrength(password);
        checkPasswordRules(password);
    });
    // 비밀번호 확인
    confirmPasswordInput === null || confirmPasswordInput === void 0 ? void 0 : confirmPasswordInput.addEventListener('input', () => {
        const password = newPasswordInput.value;
    ...
    // 폼 제출
    passwordForm === null || passwordForm === void 0 ? void 0 : passwordForm.addEventListener('submit', async (e) => {
        var _a, _b;
        e.preventDefault();
        const password = newPasswordInput.value;
        const confirm = confirmPasswordInput.value;
        ...
        // 완료 화면으로
        (_a = document.getElementById('step3')) === null || _a === void 0 ? void 0 : _a.classList.remove('active');
        (_b = document.getElementById('complete')) === null || _b === void 0 ? void 0 : _b.classList.add('active');
    });
