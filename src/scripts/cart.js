...
function updateCartDisplay() {
    ...
    if (cartItemElements.length === 0) {
        cartContent === null || cartContent === void 0 ? void 0 : cartContent.setAttribute('style', 'display: none;');
        emptyCart === null || emptyCart === void 0 ? void 0 : emptyCart.setAttribute('style', 'display: block;');
    }
    else {
        cartContent === null || cartContent === void 0 ? void 0 : cartContent.setAttribute('style', 'display: block;');
        emptyCart === null || emptyCart === void 0 ? void 0 : emptyCart.setAttribute('style', 'display: none;');
    }
    updateSummary();
}
// ==================== 전체 선택 ====================
function initSelectAll() {
    ...
    selectAllCheckbox === null || selectAllCheckbox === void 0 ? void 0 : selectAllCheckbox.addEventListener('change', () => {
...
function initDeleteSelected() {
    ...
    deleteSelectedBtn === null || deleteSelectedBtn === void 0 ? void 0 : deleteSelectedBtn.addEventListener('click', () => {
...
function initOrder() {
    ...
    orderBtn === null || orderBtn === void 0 ? void 0 : orderBtn.addEventListener('click', () => {
        var _a;
        const checkedItems = document.querySelectorAll('.item-checkbox:checked');
        if (checkedItems.length === 0) {
        ...
        const finalTotal = (_a = document.getElementById('finalTotal')) === null || _a === void 0 ? void 0 : _a.textContent;
