...
function initCommentButtons() {
    ...
    commentBtns.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            const sentenceId = card === null || card === void 0 ? void 0 : card.getAttribute('data-sentence-id');
...
function initFollowButtons() {
    ...
    followBtns.forEach(btn => {
        btn.addEventListener('click', () => {
            var _a;
            const isFollowing = (_a = btn.textContent) === null || _a === void 0 ? void 0 : _a.includes('팔로잉');
            if (isFollowing) {
                btn.textContent = '팔로우';
